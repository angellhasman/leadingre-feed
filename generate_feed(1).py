...
SESSION.headers.update(
    {
        "User-Agent": (
            "Mozilla/5.0 (compatible; AngellHasman-LeadingREFeed/5.4; "
...
def extract_bathroom_split(lines: list[str], text: str) -> tuple[str, str, str]:
    """
    ...
    # 3) Fallback: count the detailed bathroom table.
...
def parse_listing(url: str, overrides: dict) -> tuple[dict, list[str], list[str], list[str]]:
    ...
    bathrooms_full, bathrooms_half, bathrooms_total = extract_bathroom_split(lines, text)
